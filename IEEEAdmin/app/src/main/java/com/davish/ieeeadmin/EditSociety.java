...
public class EditSociety extends AppCompatActivity implements View.OnClickListener{
    EditText name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(EditSociety.this);
        ...
        DocumentReference docRef = db.collection("Society").document(currenthash);
...
// Setting Dialog Title
                alertDialog2.setTitle("Delete Society");
                ...
                alertDialog2.setPositiveButton("YES",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                db.collection("Society").document(currenthash)
                                        .delete()
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            @Override
                                            public void onSuccess(Void aVoid) {
                                                Intent I = new Intent(EditSociety.this, EditViewActivity.class);
                                                startActivity(I);
                                            }
                                        })
                    ...
                    if (name.getText().toString().length() != 0 && filePath != null) {
                        ...
                        ref.putBytes(fileInBytes)
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                // When the image has successfully uploaded, we get its downloa
...
// Add a new document with a generated ID
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        progressDialog.dismiss();
                                        Toast.makeText(EditSociety.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                })
                        ...
                        Toast.makeText( EditSociety.this, "Please add an image", Toast.LENGTH_SHORT).show();
                    else
                        Toast.makeText(EditSociety.this, "Please enter all details", Toast.LENGTH_SHORT).show();
                }
...
// Always show the chooser (if there are multiple options available)
            ...
            case R.id.imgext:
                if(click==0) {
                        ...
                        imageView.setImageDrawable(ContextCompat.getDrawable(EditSociety.this, R.drawable.ic_add_a_photo_black_24dp));
                    ...
                    ProgressDialog progressDialog = new ProgressDialog(EditSociety.this);
                    progressDialog.setTitle("Loading...");
                    progressDialog.show();
                    Bitmap bmImg = null;
                    URL myfileurl = null;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
                ...
                && data != null && data.getData() != null )
        {
            ...
            try {
                Bitmap bitmap = MediaStore.Images.Media.getBitmap(EditSociety.this.getContentResolver(), filePath);
