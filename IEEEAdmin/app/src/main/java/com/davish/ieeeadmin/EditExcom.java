...
public class EditExcom extends AppCompatActivity implements View.OnClickListener{
    EditText name, pos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_excom);
        docname="123";
        ...
        final ProgressDialog progressDialog = new ProgressDialog(EditExcom.this);
        ...
        DocumentReference docRef = db.collection("Members").document("ExCom").collection("Members").document(currenthash);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                       ...
                       pos.setText(document.getString("Position"));
...
// Setting Dialog Title
                alertDialog2.setTitle("Delete ExCom");
                ...
                alertDialog2.setPositiveButton("YES",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                db.collection("Members").document("ExCom").collection("Members").document(currenthash)
                                        .delete()
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            @Override
                                            public void onSuccess(Void aVoid) {
                                                Intent I = new Intent(EditExcom.this, EditViewActivity.class);
                                                startActivity(I);
                                            }
                                        })
...
/*        db = FirebaseFirestore.getInstance();
    ...
    public void onClick(View view)
    {
        ...
        switch (view.getId()) {
            case R.id.submit:
                if(click==1) {
                    if (name.getText().toString().length() != 0 && pos.getText().toString().length() != 0 &&
                            filePath != null) {
                        final ProgressDialog progressDialog = new ProgressDialog(EditExcom.this);
                        progressDialog.setTitle("Loading...");
                        progressDialog.show();
                        ...
                        ref = storage.getReference().child("images/excom/" + UUID.randomUUID().toString());
                        //here i am uploading
...
// Add a new document with a generated ID
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        progressDialog.dismiss();
                                        Toast.makeText(EditExcom.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                })
                        ...
                        Toast.makeText(EditExcom.this, "Please add an image", Toast.LENGTH_SHORT).show();
                    else
                        Toast.makeText(EditExcom.this, "Please enter all details", Toast.LENGTH_SHORT).show();
                }
...
// Always show the chooser (if there are multiple options available)
            ...
            case R.id.imgext:
                if(click==0) {
                        ...
                        imageView.setImageDrawable(ContextCompat.getDrawable(EditExcom.this, R.drawable.ic_add_a_photo_black_24dp));
                    ...
                    ProgressDialog progressDialog = new ProgressDialog(EditExcom.this);
                    progressDialog.setTitle("Loading...");
                    progressDialog.show();
                    Bitmap bmImg = null;
                    URL myfileurl = null;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
                ...
                && data != null && data.getData() != null )
        {
            ...
            try {
                Bitmap bitmap = MediaStore.Images.Media.getBitmap(EditExcom.this.getContentResolver(), filePath);
