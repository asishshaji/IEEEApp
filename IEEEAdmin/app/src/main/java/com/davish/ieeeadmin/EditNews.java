...
public class EditNews extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(EditNews.this);
        ...
        DocumentReference docRef = db.collection("Blogs").document(currenthash);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                       ...
                       tag.setText(document.getString("Tag"));
                       society.setText(soc);
...
// Setting Dialog Title
                alertDialog2.setTitle("Delete News");
                ...
                alertDialog2.setPositiveButton("YES",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                db.collection("Blogs").document(currenthash)
                                        .delete()
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            @Override
                                            public void onSuccess(Void aVoid) {
                                                Intent I = new Intent(EditNews.this, EditViewActivity.class);
                                                startActivity(I);
                                            }
                                        })
...
// Add a new document with a generated ID
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        progressDialog.dismiss();
                                        Toast.makeText(EditNews.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                })
                        ...
                        Toast.makeText(EditNews.this, "Please add an image", Toast.LENGTH_SHORT).show();
                    else
                        Toast.makeText(EditNews.this, "Please enter all details", Toast.LENGTH_SHORT).show();
                }
...
// Always show the chooser (if there are multiple options available)
            ...
            case R.id.imgext:
                if(click==0) {
                        ...
                        imageView.setImageDrawable(ContextCompat.getDrawable(EditNews.this, R.drawable.ic_add_a_photo_black_24dp));
                    ...
                    ProgressDialog progressDialog = new ProgressDialog(EditNews.this);
                    progressDialog.setTitle("Loading...");
                    progressDialog.show();
                    Bitmap bmImg = null;
                    URL myfileurl = null;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
                ...
                && data != null && data.getData() != null )
        {
            ...
            try {
                Bitmap bitmap = MediaStore.Images.Media.getBitmap(EditNews.this.getContentResolver(), filePath);
